...
$total_revenue = $wpdb->get_var("SELECT SUM(total_amount) FROM " . CABA_DB::get_table_name('bookings') . " WHERE status IN ('confirmed', 'pending_payment_onsite')");
